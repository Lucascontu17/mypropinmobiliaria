 ...
 * Muestra el nombre del tenant (inmobiliaria), búsqueda global y acciones rápidas.
 */
  ...
  return (
    <header className="admin-topbar flex h-16 shrink-0 items-center justify-between px-6">
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Tenant Badge */}
        <div className="flex items-center gap-3 rounded-xl border border-admin-border bg-white px-3 py-1.5">
